...
{
public:
	DNAError(string msgIn, ErrorPriority priorityIn, Token tokenIn=nullptr);
...
//typedef shared_ptr<DNAError> Err;

//Err makeError(string msgIn, ErrorPriority priorityIn, Token tokenIn=nullptr) {return Err(new DNAError(msgIn, priorityIn, tokenIn));}